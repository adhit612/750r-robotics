...
void Robot::intakeFor(double distance, int mode)
{
  vex::motor m = vex::motor(LEFT_ROLLER_MOTOR, false);
  vex::motor m2 = vex::motor(RIGHT_ROLLER_MOTOR, true);
  m.rotateFor(vex::directionType::fwd, distance*mode, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, false);
  m2.rotateFor(vex::directionType::fwd, distance*mode, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, true);
}

void Robot::magazineFor(int distance,int mode)
{
  vex::motor m = vex::motor(MAGAZINE_MOTOR);
  vex::motor m2 = vex::motor(LEFT_ROLLER_MOTOR,false);
  vex::motor m3 = vex::motor(RIGHT_ROLLER_MOTOR, true);
  m.rotateFor(vex::directionType::fwd, 1500, vex::rotationUnits::deg, 50, vex::velocityUnits::pct, true);
}

void Robot::magazineBack()
{
  vex::motor m = vex::motor(MAGAZINE_MOTOR);
  vex::motor m2 = vex::motor(LEFT_ROLLER_MOTOR,false);
  vex::motor m3 = vex::motor(RIGHT_ROLLER_MOTOR, true);
  m.rotateFor(vex::directionType::fwd, -1000, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, true);
}
...
void Robot::intakeAndMove(double distance, double velocity,int mode)
{
  ...
  m.rotateFor(vex::directionType::fwd, distance*1.5, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, false);
  m2.rotateFor(vex::directionType::fwd, distance*1.5, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, true);
}
...
void Robot::deploy()
{
  ...
  vex::motor m2 = vex::motor(LEFT_ROLLER_MOTOR,false);
  vex::motor m3 = vex::motor(RIGHT_ROLLER_MOTOR, true);
  m2.rotateFor(vex::directionType::fwd, -1000, vex::rotationUnits::deg, 100, vex::velocityUnits::pct, false);
